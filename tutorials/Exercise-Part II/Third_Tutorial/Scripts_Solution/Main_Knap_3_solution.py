...
from Policies_Knap_3_solution import Policy, Greedy, Threshold, Reserve_Cap, Sample, Perfect_Information
import pandas as pd
import time
...
if __name__ == "__main__":
    ...
    evaluated_policies: list[str] = ["Greedy", "Threshold", "Reserve_Cap", "Sample", "Perfect_Information"] # select policies that should be investigated in the current simulation
