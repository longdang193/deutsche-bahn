...
from Policies_Knap_5 import Policy, Greedy, Threshold, Reserve_Cap, Sample, Perfect_Information, MC_RL
import pandas as pd
import time
...
if __name__ == "__main__":
    ...
    if "MC_RL" in evaluated_policies: # if monte carlo reinforcement learning policy should be evaluated
        ...
        use_pre_trained_table: bool = True # if pretrained lookup table should be used
        ...
        if use_pre_trained_table: # if pretrained lookup table should be used
            ...
            n_train_epochs: int = int(1e3) # number of training epochs
