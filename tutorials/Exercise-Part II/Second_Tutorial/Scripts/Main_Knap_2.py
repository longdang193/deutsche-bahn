...
from Environment_Knap_2 import KnapsackEnvironment
from Policies_Knap_2 import Policy, Greedy
import pandas as pd
import time
...
if __name__ == "__main__":
    ...
    evaluated_policies: list[str] = ["Greedy"] # select policies that should be investigated in the current simulation
