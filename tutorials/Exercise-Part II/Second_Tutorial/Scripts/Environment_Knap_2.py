...
class KnapsackEnvironment:
    ...
    def terminated():
        ...
        """
        TODO: Write a Function "terminated" that returns True (simulation terminates) or 
        False (simulation continues), depending on the current state
        Hint: There are two termination criteria in the dynamic knapsack problem
        """
    ...
    def step():
        ...
        """
        TODO: Write a Function "step" 
        1. Argument: action
        2. Update the total reward and knapsack capacity if action is True
        3. Update current decision point
        4a. If simulation terminates, return the final state, and True
        4b. If simulation does not terminate, return the next state, and False
        """
