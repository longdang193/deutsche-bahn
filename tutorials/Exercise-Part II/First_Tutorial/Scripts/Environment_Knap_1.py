...
class KnapsackEnvironment:
    ...
    def create_items(self, seed: int) -> list[Item]:
        ...
        """
        TODO: Consider the following tasks regarding the creation of the item list
        1. Create a loop over all decision points
        2. Create an object of the class "Item" and append it to the item list: respect the required arguments when creating an item
        """   
