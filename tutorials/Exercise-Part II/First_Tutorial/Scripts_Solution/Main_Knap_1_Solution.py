...
from Environment_Knap_1_Solution import KnapsackEnvironment
from Item_Knap_1_Solution import Item
import pandas as pd
...
if __name__ == "__main__":
    ...
    final_items.to_csv("First_Tutorial/Item_Data.txt", sep='\t') # save item list in .txt file
    print(final_items) # print out final item list
    print(first_state) # print out first state